...
public final class QueryUtils {
    ...
    /**
     * Query the Google Books database and return a list of {@link Book} objects.
     */
    ...
    private static List<Book> extractVolumeFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // For a given book, extract the JSONObject associated with the
                // key called "imageLinks", which represents a list of visual assets
                // for that book.
                ...
                // Create a new {@link Book} object with the title, author, publication date,
                // url and cover image url from the JSON response.
                Book book = new Book(title, author, publicationDate, url, coverImageUrl);
